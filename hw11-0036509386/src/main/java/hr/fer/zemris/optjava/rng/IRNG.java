...
public interface IRNG {
     ...
     *
     * @param min donja granica intervala (uključiva) * @param max gornja granica intervala (isključiva)
     *
     * @return slučajno generirani cijeli broj
     */
    ...
    /**
     * Vraća slučajno generiranu boolean vrijednost. Vrijednosti se izvlače * iz uniformne distribucije.
     *
